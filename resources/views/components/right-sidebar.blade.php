<div class="flex flex-col w-1/3 h-full gap-[10px]">
    ...
    <div class="w-full p-4 bg-darkCard   rounded-[12px] h-2/3 overflow-y-scroll" id="sidebar_list">
        <header class="flex gap-[5px] mb-[8px]">
            <h2 class=" text-end text-white text-[20px] font-semibold">Last Expenses</h2>
            <a href="" class=" text-highlight mt-auto text-[12px] h-full pr-[18px] hover:animate-pulse hover:font-bold">See all</a>
        </header>
